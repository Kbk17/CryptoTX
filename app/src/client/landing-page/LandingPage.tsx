...
export default function LandingPage() {
  ...
  const NavLogo = () => <img className='h-12 w-42' src={logo} alt='BorCash Logo' />;
  ...
  return (
    <div className='bg-white dark:text-white dark:bg-boxdark-2'>
      ...
      <main className='isolate dark:bg-boxdark-2'>
            ...
            <div className='mx-auto max-w-8xl px-6 lg:px-8'>
              <div className='lg:mb-18 mx-auto max-w-3xl text-center'><h1 className='text-4xl font-bold text-gray-900 sm:text-6xl dark:text-white'>
                ...
                <div className='mt-10 flex items-center justify-center gap-x-6'>
                  <a
                    href={SIGNUP_PAGE}
                    className='rounded-md px-5 py-2.5 text-lg font-semibold text-gray-700 bg-yellow-300 ring-1 ring-inset ring-yellow-300 hover:bg-transparent hover:ring-2 hover:ring-yellow-300 shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 dark:text-white" style="background-color: rgba(234, 179, 8, var(--tw-text-opacity)) !important;'
                  >
                    Make Deposit  <span aria-hidden='true'>→</span>
                  </a>
                </div>
              </div>
        ...
        {/* Feature section */}
        <div id='features' className='mx-auto mt-0 max-w-7xl px-6 lg:px-8'>
...
{/* Footer */}
<div className='mx-auto mt-6 max-w-7xl px-4 sm:px-6 lg:px-8 dark:bg-boxdark-2'>
  <footer
    aria-labelledby='footer-heading'
    className='relative border-t border-gray-900/10 dark:border-gray-200/10 py-10 sm:py-24 flex flex-col sm:flex-row justify-between'
  >
    <div className='flex flex-col sm:flex-row sm:items-start'>
      {/* Left Column - Logo and Address */}
      <div className='flex flex-col mb-6 sm:mb-0 sm:mr-20'>
        <NavLogo />
      ...
      <div className='flex flex-col sm:mr-10 lg:mr-20'>
        ...
        <div>
          ...
          <p className='text-sm text-gray-600 dark:text-white'>+48 33 823 41 56</p>
          <p className='text-sm text-gray-600 dark:text-white'>+48 19 115 821</p>
        </div>
      </div>
    </div>

    {/* Existing Right Content */}
    <div className='flex flex-col sm:flex-row items-start gap-6 sm:gap-20 mt-6 sm:mt-0'>
      <div>
